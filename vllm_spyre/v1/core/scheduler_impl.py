...
"""
Spyre scheduler implementations.

This module provides Spyre scheduler classes that can inherit from either
sync or async base schedulers based on the VLLM_SPYRE_ENABLE_ASYNC_SCHEDULING
...
# Conditionally select the base scheduler class based on async scheduling flag
# Import directly from vLLM to avoid circular imports
if envs_spyre.VLLM_SPYRE_ENABLE_ASYNC_SCHEDULING:
    from vllm.v1.core.sched.async_scheduler import AsyncScheduler as BaseScheduler
else:
    from vllm.v1.core.sched.scheduler import Scheduler as BaseScheduler


class PoolingSpyreScheduler(BaseScheduler):  # type: ignore
...
class ChunkedPrefillSpyreScheduler(BaseScheduler):  # type: ignore
    """
    ...
    def update_from_output(self, scheduler_output, model_runner_output):
        ...
        if not model_runner_output.req_ids:
            ...
            if envs_spyre.VLLM_SPYRE_ENABLE_ASYNC_SCHEDULING and scheduler_output.num_scheduled_tokens:
                import dataclasses
