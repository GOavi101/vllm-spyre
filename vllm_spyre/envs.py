...
if TYPE_CHECKING:
    ...
    VLLM_SPYRE_ENABLE_ASYNC_SCHEDULING: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Enable async scheduling for better GPU utilization and throughput.
    # Async scheduling helps to avoid gaps in GPU utilization by processing
    # outputs asynchronously from scheduling. This is now supported via
    # AsyncPoolingSpyreScheduler and AsyncChunkedPrefillSpyreScheduler.
    # Disabled by default for backward compatibility.
    "VLLM_SPYRE_ENABLE_ASYNC_SCHEDULING": lambda: bool(
        int(os.getenv("VLLM_SPYRE_ENABLE_ASYNC_SCHEDULING", "0"))
    ),
}
